          ...
          <div className="px-6 pb-6">
            <div className="flex items-end justify-between -mt-10 mb-4">
              ...
              {!isEditing ? (
                <Button
                  ...
                  size="sm"
                  onClick={handleEdit}
                  className="bg-slate-800 border-slate-700 text-slate-300 hover:text-white hover:bg-slate-700 rounded-xl"
                >
            ...
            {isEditing ? (
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    maxLength={100}
                    className="bg-slate-800 border-slate-700 text-white focus:border-slate-500 rounded-xl"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
                  ...
                  <Input
                    ...
                    className="bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:border-slate-500 rounded-xl"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm mt-0.5">@{profile.handle}</p>
                {profile.bio && (
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Karma</span>
            </div>
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-5">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-slate-800 rounded-xl px-4 py-3 flex-1">
              <span className="text-slate-400 font-mono text-lg">@{profile.handle}</span>
            </div>
            <p className="text-xs text-slate-500">Unique identifier — visible to others</p>
          </div>
          <p className="text-xs text-slate-600 mt-2">
